        ...
        when{
            model.getIsSelected() -> {
                holder.tvItem.background =
                    ContextCompat.getDrawable(holder.itemView.context, R.drawable.item_circular_thin_accent_color_border)
            ...
            model.getIsCompleted() -> {
                ...
                holder.tvItem.background =
                    ContextCompat.getDrawable(holder.itemView.context, R.drawable.item_circular_gray_color_background)
                holder.tvItem.setTextColor(Color.parseColor("#212121"))
            }
        }
    }
